...
const ConversationBox: React.FC<ConversationBoxProps> = ({
    ...
    }, [lastMessage, userPhoneNumber])

    return (
    <div>
        <div
            onClick={handleClick}
            className={clsx(`relative flex items-center space-x-3 p-3 hover:bg-neutral-100 transition cursor-pointer`, selected ? 'bg-neutral-100' : 'bg-white' )}>
